...
<body>
	<div>
        ...
        <div>
          ...
          <a name="bottom"></a>
            	<div class="section">
                  <div class="header_font_m"><a href="mytasks.php" class="button_small">My Tasks</a>  &raquo; Overdue Tasks</div>
                </div>
          </div>         
...
AND wftskstatustypes_idwftskstatustypes=0 
AND wftasks.timedeadline<='".$timenowis."'
GROUP BY wftasks.tktin_idtktin 
ORDER BY tktin.timereported DESC ";
