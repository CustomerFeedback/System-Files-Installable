...
<body>
	<div>
        ...
        <div>
          ...
          <a name="bottom"></a>
            	<div class="section">
                  <div class="header_font_m"><a href="mytasks.php" class="button_small">My Tasks</a>  &raquo; In Progress</div>
                </div>
          </div>         
...
AND wftskstatustypes_idwftskstatustypes=6 AND wftskstatusglobal_idwftskstatusglobal=2 
